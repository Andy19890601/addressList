...
public class StudentDto {
	...
	public String toString() {
		return "StudentDto [studentID=" + studentID + ", studentPWD="
				+ studentPWD + ", studentName=" + studentName + ", studentSex="
				+ studentSex + ", studentPicturePath=" + studentPicturePath
				+ ", studentEnrollment=" + studentEnrollment
				+ ", studentMajor=" + studentMajor + ", studentTutor="
				+ studentTutor + ", studentGoodAt=" + studentGoodAt
				+ ", studentEmail=" + studentEmail + ", studentCall="
				+ studentCall + ", studentQQ=" + studentQQ + ", studentWeChat="
				+ studentWeChat + ", studentWeiBo=" + studentWeiBo
