...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select id='stuProvience' name='stuProvience'></select>");
	_self.append("<select id='stuCity' name='stuCity'></select>");
	_self.append("<select id='stuCounty' name='stuCounty'></select>");
	//分别获取3个下拉框
