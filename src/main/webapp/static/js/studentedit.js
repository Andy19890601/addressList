$(document).ready(function(){
	$('#basicInfo_hander_save').click(function(){
		var year = $('#birthdaydd').children('select:eq(0)').val();
		var month = $('#birthdaydd').children('select:eq(1)').val();
		var date = $('#birthdaydd').children('select:eq(2)').val();
		var birthday = year+','+month+','+date;
		$('#studentBirthday').val(birthday);
		
		var province = $('#stuHomeTown').children('select:eq(0)').val();
		var city = $('#stuHomeTown').children('select:eq(1)').val();
		var county = $('#stuHomeTown').children('select:eq(2)').val();
		var hometown = province+','+city+','+county;
