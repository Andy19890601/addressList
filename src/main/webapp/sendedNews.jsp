		...
		<div class="container_left">
			<div>
				<ul>
					...
					<a href="listReadMsg"><li>已读信息</li></a>
					<a href="listSendedMsg"><li style="color: crimson;">已发送</li></a>
				</ul>
			</div>
		</div>
			...
			<div id="newsDivId_<%=i%>" class="newsDIV">
				<div class="topLineDIV">
					...
					<div class="userFromDIV">
						<span>发送给：</span>
						<span id="userFromDivName"
							class='userFromDIV_stuName'><%=msg.getReceiverName()%>
						</span> 
						<input id="userFromDivID" type='input' class='fromStuId userFromDIV_stuID' value="<%=msg.getSender() %>"
							style='display: none;'> 
						<input type='input' id="msgReplyContent"
					...
					<div class="bottomLineDIV">
						<div>
							<span class="bottomLineSpan mark" style="display:none">标记为已读</span> <span
								class="bottomLineSpan reply" style="display:none">回复</span> <span
		...
		<div class="MessageDIV">
			...
			<div class="replyMessageDIV">
				<form action="replyMsg" id="replyMessageForm">
					...
					<textarea maxlength='140' name="sendContent"
