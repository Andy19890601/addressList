...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	Student stuInfo = (Student) request
			.getAttribute("studentUpdatingInfo");
%>
...
<body>
	...
	<div class="stuInfoDiv">
		...
		<div id="stuInfoDivData">
			<form id="stuInfoForm" method="post" action="updatingStudentInfo">
				<input name="id" value="stuInfo.getId()" type="hidden" />
				<fieldset>
					<lable for="stuID">学号:<%=stuInfo.getStudentID()%></lable>
					<input readonly="readonly" type="hidden" name="studentID" id="stuName"
						value="<%=stuInfo.getStudentID()%>" />
					<br>
					<lable for="stuName">姓名</lable>
					<input maxlength="20" type="input" name="studentName" id="stuName"
						value="<%=stuInfo.getStudentName()%>" /><font style="color: red;">*</font>
					<br>
					...
					<select name="studentMajor" id="stuMajor" class="stuMajor"
						value="<%=stuInfo.getStudentMajor()%>" />
					
					<option>--请选择--</option>
					<option>软件开发</option>
					<option selected="selected" >软件测试与质量保证</option>
					...
					<input type="input" name="studentTutor" id="stuTutor"
						value="<%=stuInfo.getStudentTutor()%>" /><font style="color: red;">*</font>
					<br>
		...
		<br> -->
					...
					<lable>Email&nbsp;&nbsp;&nbsp;&nbsp;</lable>
					<input type="input" name="studentEmail" id="stuEmail" style=""
						value="<%=stuInfo.getStudentEmail()%>" /><font style="color: red;">*</font>
					<span id="error1" style="color: red; display: none;">邮箱不能为空</span>
					<span id="error2" style="color: red; display: none;">邮箱格式不正确</span>
					<br>
					<lable>电话&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</lable>
					<input maxlength="20" type="input" name="studentCall" id="stuCall"
						value="<%=stuInfo.getStudentCall()%>" /> <br>
					<lable>QQ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</lable>
					<input maxlength="20" type="input" name=studentQQ id="stuEmail"
						value="<%=stuInfo.getStudentEmail()%>" /> <br>
					<lable>微信&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</lable>
					...
					<input maxlength="20" type="input" name="studentPresentAddress"
						id="studentPresentAddress" value="<%=stuInfo.getStudentPresentAddress()%>"/> <br>

					<lable for="stuCompany">工作单位</lable>
					<input maxlength="20" type="input" name="studentCompany"
						value="<%=stuInfo.getStudentCompany()%>" id="stuCompany" /> <br>

					<lable for="stuPost">职位&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</lable>
					<input maxlength="20" type="input" name="studentPost" id="stuPost"
						value="<%=stuInfo.getStudentPost()%>" /> <br>
					...
					<textarea name="studentDescription" id="stuDescription" cols="60"
						...
						onblur="if (value ==''){value='填写擅长领域或求职、内推、招聘等信息140字以内'}"><%=stuInfo.getStudentDescription()%></textarea>
					<br> <input type="submit" id="stuInfoSubmit" value=" 保存  "
