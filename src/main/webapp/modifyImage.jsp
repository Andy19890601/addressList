  ...
  <body>
   ...
   <div style="min-height: 388px;">
	   ...
	   <div style="text-align:center;margin-bottom:5px;"><span style="font: 20px/1.125 Arial,Helvetica,sans-serif;text-align:center;">请上传自己的真实头像</span></div>
		   <form  action="updateUploadImg" method="POST" enctype="multipart/form-data">
			 <fieldset>    
			      ...
			      <input type="button"  id="nextStepButton" class="" style="height:30px;width:75px;float:right;" value='保存' />
			 		<div>
			 </fieldset>      	 
		   </form>
	   </div>
